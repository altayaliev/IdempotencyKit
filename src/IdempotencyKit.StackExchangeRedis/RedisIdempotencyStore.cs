...
public sealed class RedisIdempotencyStore : IIdempotencyStore
{
    ...
    public RedisIdempotencyStore(IConnectionMultiplexer connectionMultiplexer, TimeProvider? timeProvider = null, string keyPrefix = "idempotencykit:")
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var freshEnvelope = new RedisEnvelope
        {
            ...
            }, IdempotencyKitJsonContext.Default.IdempotencyRecord)
        };
        ...
        return kind switch
        {
            ...
            _ => throw new InvalidOperationException($"Unexpected IdempotencyKit Redis script result: '{kind}'.")
        };
    }
    ...
    public async Task CompleteAsync(string key, IdempotencyRecord record, CancellationToken cancellationToken = default)
    {
        ...
        var envelope = new RedisEnvelope
        {
            ...
            RecordJson = JsonSerializer.Serialize(record, IdempotencyKitJsonContext.Default.IdempotencyRecord)
        };
    ...
    private static IdempotencyRecord ToRecord(string envelopeJson)
    {
        ...
        return JsonSerializer.Deserialize(envelope.RecordJson, IdempotencyKitJsonContext.Default.IdempotencyRecord)!;
    }
}
