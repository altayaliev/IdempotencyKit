...
public static class IdempotencyKitServiceCollectionExtensions
{
    /// <summary>
    /// Registers IdempotencyKit's default services: an in-memory <see cref="IIdempotencyStore"/>, the
    ...
    /// <c>app.UseIdempotencyKit()</c> to wire in the middleware. Register your own
