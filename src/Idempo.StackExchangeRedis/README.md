...
builder.Services.AddIdempoStackExchangeRedisStore(); // optional keyPrefix:, default "idempo:"
```
...
builder.Services.AddSingleton<IConnectionMultiplexer>(
    ConnectionMultiplexer.Connect("localhost:6379"));
builder.Services.AddIdempo();
builder.Services.AddIdempoStackExchangeRedisStore(); // istəyə bağlı keyPrefix:, default "idempo:"
```
