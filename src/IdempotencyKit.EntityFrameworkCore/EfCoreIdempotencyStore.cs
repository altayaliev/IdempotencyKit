    ...
    where TContext : DbContext
{
    ...
    private static IdempotencyRecordEntity ToEntity(IdempotencyRecord record) => new()
    {
        ...
        HeadersJson = record.Headers is null ? null : JsonSerializer.Serialize(record.Headers, IdempotencyKitJsonContext.Default.IReadOnlyDictionaryStringStringArray),
    ...
    private static IdempotencyRecord ToRecord(IdempotencyRecordEntity entity) => new()
    {
        ...
        Headers = entity.HeadersJson is null
            ? null
            : JsonSerializer.Deserialize(entity.HeadersJson, IdempotencyKitJsonContext.Default.IReadOnlyDictionaryStringStringArray),
